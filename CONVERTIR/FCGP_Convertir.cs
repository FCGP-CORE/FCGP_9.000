...
namespace FCGP
{
    ...
    internal static class FCGP_Convertir
    {
        /// <summary> Point d'entrée principal de l'application. </summary>
        [STAThread]
        internal static void Main()
        {
            string GuidID = "FCGP_CONVERTIR_CS_CORE";
            // retrouve le Guid associé à l'assembly pour pouvoir rendre l'instance unique
            var AttributsAssembly = typeof(FCGP_Convertir).Assembly.CustomAttributes;
